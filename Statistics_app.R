...
server <- function(input, output, session){
  ...
  output$contents <- renderPrint({
      return(
        if(input$type_of_test == "unpaired_2_tailed_students_t_test"){
          return("Unpaired two-tailed Studnent's t-test will be conduced using R: t.test and power_t_test. Code adapted from Sultan et al., 2021 (https://doi.org/10.3389/fcell.2021.726281)")
        } else if (input$type_of_test == "paired_2_tailed_students_t_test"){
          return("Paired two-tailed Studnent's t-test will be conduced using R: t.test and power_t_test. Code adapted from Sultan et al., 2021 (https://doi.org/10.3389/fcell.2021.726281)")
        }else if (input$type_of_test == "unpaired_2_tailed_welchs_t_test"){
          return("Unpaired two-tailed Welch's t-test will be conduced using R: t.test and power_t_test. Code adapted from Sultan et al., 2021 (https://doi.org/10.3389/fcell.2021.726281)")
        }else if (input$type_of_test == "paired_2_tailed_welchs_t_test"){
          return("Paired two-tailed Welch's t-test will be conduced using R: t.test and power_t_test. Code adapted from Sultan et al., 2021 (https://doi.org/10.3389/fcell.2021.726281)")
        }else if (input$type_of_test == "unpaired_2_tailed_wilcoxon_test"){
          return("Unpaired two-tailed WMW test will be conduced using R: wilcox.test, shiehpow, and WMWssp. Code adapted from Sultan et al., 2021 (https://doi.org/10.3389/fcell.2021.726281)")
        }else if (input$type_of_test == "paired_2_tailed_wilcoxon_test"){
          return("Paired two-tailed WMW test will be conduced using R: R: wilcox.test, shiehpow, and WMWssp. Code adapted from Sultan et al., 2021 (https://doi.org/10.3389/fcell.2021.726281)")
        }
      ) 
    })
}
